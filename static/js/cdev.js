$(document).ready(function () {
  ...
  searchInput.keydown(function (_event) {
    // key pressed<animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 40 40" to="360 40 40" dur="0.8s" repeatCount="indefinite"/> 
    clearTimeout(typingTimer)
  })
...
// Cart Async Buy/In Cart and Remove Button
