import json
import stripe
# import razorpay # indian payment gateway
...
#         auth=(settings.RAZORPAY_API_KEY_PUBLISHABLE, settings.RAZORPAY_API_KEY_HIDDEN)
#     )
...
def create_checkout_session(request):
    ...
    #     client = razorpay.Client(
    #         auth=(
    #             settings.RAZORPAY_API_KEY_PUBLISHABLE,
    ...
    #         client_id=settings.PAYPAL_API_KEY_PUBLISHABLE,
